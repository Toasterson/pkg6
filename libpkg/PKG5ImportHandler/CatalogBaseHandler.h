...
namespace pkg {
    struct CatalogBaseHandler : public BaseReaderHandler<UTF8<>, CatalogBaseHandler> {
        CatalogBaseHandler(Catalog& catalog, Progress& progress) : state_(kExpectObjectStart), catalog(catalog), progress(progress) {}
